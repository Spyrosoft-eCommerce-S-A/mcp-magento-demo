<?php
namespace Spyrosoft\MCPChatBotv2\Controller\Openapi;
...
class Index implements HttpGetActionInterface // Renamed to Index to match openapi.json path
{
    protected $response;
    ...
    public function execute(): ResponseInterface
    {
        try {
            ...
            $filePath = $moduleDir . '/../pub/openapi.json'; // Path relative to etc directory
